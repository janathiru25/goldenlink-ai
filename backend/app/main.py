...
async def lifespan(app: FastAPI):
    ...
    logger.info(f"AI Provider initialized: {ai_status.provider} (mode: {ai_status.mode})")
    yield
...
app = FastAPI(
    ...
    description="Emergency Incident Coordination, AI Triage, Responder Matching & Hospital Recommendation API",
    version="1.0.0",
    lifespan=lifespan
)
